    ...
    <main>
      ...
      <section className="py-12 px-4 bg-slate-50 border-y border-slate-200">
        <div className="max-w-2xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-lg font-bold text-slate-900">Watch on YouTube</p>
            <p className="text-sm text-slate-500 mt-1">Hear every Bible name pronounced correctly — video guides with 3 voices.</p>
          </div>
          <a
            href="https://www.youtube.com/channel/UCCUCdfSvI-kQWwh207T_k-Q?sub_confirmation=1"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 bg-[#FF0000] hover:bg-[#cc0000] text-white text-sm font-bold rounded-lg transition-colors shrink-0"
          >
